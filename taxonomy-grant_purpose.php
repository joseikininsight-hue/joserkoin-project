<?php
/**
 * Category Archive Template for Grant - 単体表示専用版 v18.2
 * 
 * グリッド切替機能を削除し、単体表示（ポータル型）のみに特化
 * 
...
$page_description = $category_name . 'に関する助成金・補助金を' . $category_count . '件掲載。' . $current_year . '年度の最新募集情報、申請要件、対象事業、助成金額、締切日を詳しく解説。都道府県・市町村別の検索も可能。';
...
<main class="grant-archive-optimized" id="category-<?php echo esc_attr($category_slug); ?>" itemscope itemtype="https://schema.org/CollectionPage">
...
(function() {
    ...
    function init() {
        console.log('🚀 Category archive initialized (Portal Type Only):', CATEGORY_SLUG);
