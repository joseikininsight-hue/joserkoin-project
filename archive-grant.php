<?php
/**
 * Archive Template for Grant Post Type - プルダウン式完全版 v17.0
 * 
 * カテゴリアーカイブと同じプルダウン式フィルター・単体表示ベース・AI機能搭載
 * 
...
<main class="grant-archive-optimized" id="grant-archive" itemscope itemtype="https://schema.org/CollectionPage">
            ...
            <div class="hero-content-wrapper">
                ...
                <div class="category-meta-info">
                    <div class="meta-item">
                        ...
                        <strong><?php echo number_format(wp_count_posts('grant')->publish); ?></strong>件の助成金
                    </div>
                    <div class="meta-item">
                        <svg class="meta-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                ...
                <div class="filter-dropdown-wrapper" id="municipality-wrapper" style="display: none;">
                    <label class="filter-label" id="municipality-label">
                        <svg class="label-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                            ...
                            <path d="M9 22V12h6v10M210.6L12 2l10 8.6"/>
                        </svg>
                        市町村
...
(function() {
    ...
    function init() {
        console.log('🚀 Archive page initialized (Dropdown + Single View Base)');
    ...
    console.log('✅ Archive page loaded (Dropdown + Single View Base)');
})();
</script>
